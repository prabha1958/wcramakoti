                ...
                <form wire:submit.prevent="update">
                    ...
                    <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4 mb-4">
                        ...
                        <div class="mt-2" x-show="! photoPreview">
                            @if(isset($this->theme_photo))
                            <img src="{{ Storage::url('themes/'.$this->theme_photo)}}" alt="{{ $this->theme }}" class="rounded-full h-20 w-20 object-cover">
                            @else
                            <img src="{{asset('images/dummy.jpeg')}}" alt="{{ $this->theme }}" class="rounded-full h-20 w-20 object-cover">
                            @endif
                    ...
                    <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                        ...
                        <x-jet-label for="photo" value="{{ __('Audience Photo') }}" />
                         <!-- photo preview-->
                         <div class="mt-2" x-show="! photoPreview">
                            @if(isset($this->audience_photo))
                            <img src="{{ Storage::url('audiences/'.$this->audience_photo)}}" alt="{{ $this->theme }}" class="rounded-full h-20 w-20 object-cover">
                            @else
                            <img src="{{asset('images/dummy.jpeg')}}" alt="{{ $this->theme }}" class="rounded-full h-20 w-20 object-cover">
                            @endif
                    ...
                    <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                        ...
                        <x-jet-label for="photo" value="{{ __('Choir Photo') }}" />
                         <!-- photo preview-->
                         <div class="mt-2" x-show="! photoPreview">
                            @if(isset($this->choir_photo))
                            <img src="{{ Storage::url('choirs/'.$this->choir_photo)}}" alt="{{ $this->theme }}" class="rounded-full h-20 w-20 object-cover">
                            @else
                            <img src="{{asset('images/dummy.jpeg')}}" alt="{{ $this->theme }}" class="rounded-full h-20 w-20 object-cover">
                            @endif
                    ...
                    <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                        ...
                        <x-jet-label for="photo" value="{{ __('Pastor Photo') }}" />
                         <!-- photo preview-->
                         <div class="mt-2" x-show="! photoPreview">
                            @if(isset($this->pastor_photo))
                            <img src="{{ Storage::url('priests/'.$this->pastor_photo)}}" alt="{{ $this->theme }}" class="rounded-full h-20 w-20 object-cover">
                            @else
                            <img src="{{asset('images/dummy.jpeg')}}" alt="{{ $this->theme }}" class="rounded-full h-20 w-20 object-cover">
                            @endif
