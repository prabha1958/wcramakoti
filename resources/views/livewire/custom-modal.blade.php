<div>
    <x-jet-button wire:click="showModal" wire:loading.attr="disabled" class="p-4 mt-3 text-theme-l4 cursor-pointer">
        Add New
    </x-jet-button>
            ...
            <x-jet-authentication-card>
                ...
                <form method="POST" action="{{ route('create.pastor') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-textarea id="bio"  rows="4" cols="40"  name="bio" :value="old('bio')" required autofocus></x-textarea>
                    </div>
